...
export class Checklist extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        this.add(tittle); // this moves the title to the container so it moves with the checklist stuff
        ...
        this.createItem(20, 300, 'Watsonville, CA (phone: 831-555-4821)'); // added a fun item to the checklist, feel free to remove it if you want
